from math import factorial, cos, pi, sin
...
# Вычисление аппроксимации интеграла, используя метод центральных прямоугольников
def middle_rectangular(func, a, b, n):
    h = (b - a) / n
    return sum(func(a + h * (i + 0.5)) * h for i in range(n))


# Вычисление теоретической оценки погрешности для метода центральных прямоугольников
